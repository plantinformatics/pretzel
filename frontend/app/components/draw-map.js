...
//const drawMapComponent = Ember.Component.extend({});

//drawMapComponent.reopenClass({
	//positionalParams:['mapset']
//});

//console.log("TETEET " + drawMapComponent.positionalParams[0]);
//drawMapComponent
