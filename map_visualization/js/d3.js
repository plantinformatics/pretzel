d3 = function() {
  ...
  d3.behavior.zoom = function() {
    ...
    function mousewheeled() {
      ...
      //comment the above line and add Ideogramview specific
      var p = [d3.event.clientX-110, d3.event.clientY-150];
      var point = center || p;
      //end of Ideogramviewer specific
    ...
    function dblclicked() {
      ...
      //Ideogram viewer specific
      p = [d3.event.clientX-110, d3.event.clientY-150];
      //p = [p[0]-110, p[1]-150];   //event.client return the coordinate relative to window, more accruate
      l = location(p);
      //end of Ideogram viewer specific
      zoomstarted(event_);
